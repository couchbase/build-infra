...
resource "aws_ssm_parameter" "shared_ssh_patch_via_gerrit_ini" {
  name  = "jenkins-worker__shared__.ssh__patch_via_gerrit.ini"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "shared_ssh_id_ns_codereview" {
  name  = "jenkins-worker__shared__.ssh__id_ns-codereview"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "shared_ssh_id_buildbot" {
  name  = "jenkins-worker__shared__.ssh__id_buildbot"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "shared_ssh_buildbot_id_dsa" {
  name  = "jenkins-worker__shared__.ssh__buildbot_id_dsa"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "shared_gitconfig" {
  name  = "jenkins-worker__shared__.gitconfig"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "shared_ssh_known_hosts" {
  name  = "jenkins-worker__shared__.ssh__known_hosts"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "shared_ssh_environment" {
  name  = "jenkins-worker__shared__.ssh__environment"
  type  = "SecureString"
...
resource "aws_ssm_parameter" "couchbase_server_mobile_ssh_config" {
  name  = "jenkins-worker__mobile__.ssh__config"
  type  = "SecureString"
  value = file("~/aws-ssh/couchbase-server/build/linux/.ssh/config")
  tags = {
    Owner = "build-team"
