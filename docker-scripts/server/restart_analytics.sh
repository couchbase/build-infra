...
${SCRIPTPATH}/../restart_jenkinsdocker.py --no-std-mounts couchbasebuild/zz-lightweight:20210205 zz-analytics-lightweight-01 2212 analytics.jenkins.couchbase.com
