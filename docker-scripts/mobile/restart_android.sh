...
${SCRIPTPATH}/../restart_jenkinsdocker.py --no-std-mounts --no-workspace couchbasebuild/ubuntu1604-mobile-lite-android:20191217 mobile-lite-android    6502 mobile.jenkins.couchbase.com
${SCRIPTPATH}/../restart_jenkinsdocker.py --no-std-mounts --no-workspace couchbasebuild/ubuntu1604-mobile-lite-android:20191217 mobile-lite-android-02 6503 mobile.jenkins.couchbase.com
