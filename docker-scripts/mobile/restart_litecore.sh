...
${SCRIPTPATH}/../restart_jenkinsdocker.py --no-std-mounts couchbasebuild/centos-69-litecore-build-gcc:20200505 mobile-litecore-centos6-gcc 6507 mobile.jenkins.couchbase.com
